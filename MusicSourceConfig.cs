...
namespace ACS_4Series_Template_V1.MusicSources
{
    ...
    {
        public MusicSourceConfig(ushort number, string name, string iconSerial, ushort analogModeNumber, ushort switcherInputNumber, ushort flipsToPageNumber, ushort equipID)
        {
            this.Number = number;
            this.Name = name;
